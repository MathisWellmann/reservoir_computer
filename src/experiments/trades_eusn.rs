...
use crate::{INPUT_DIM, OUTPUT_DIM, Series, activation::Activation, esn::{Inputs, Params, ESN}, euler_state_network::{EuSNParams, EulerStateNetwork}, load_sample_data, plot::plot, utils::scale};
...
pub(crate) fn start() {
    ...
    plot(&plot_targets, &train_predictions, &plot_predictions, "img/trades_eusn.png", (2160, 2160));
}
